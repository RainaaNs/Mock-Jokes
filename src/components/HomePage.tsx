    ...
    if (currentJoke) {
      try {
        ...
        if (response.ok) {
          ...
          setLiked((prevLiked) => [...prevLiked, currentJoke]);

          setDisliked((prevDisliked) =>
            prevDisliked.filter((joke) => joke.id !== currentJoke.id)
          );
    ...
    if (currentJoke) {
      try {
        ...
        if (response.ok) {
          ...
          setDisliked((prevDisliked) => [...prevDisliked, currentJoke]);

          setLiked((prevLiked) =>
            prevLiked.filter((joke) => joke.id !== currentJoke.id)
          );
